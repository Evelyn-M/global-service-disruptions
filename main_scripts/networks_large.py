...
# ROADS
# for large countries: take main_road only and further exlucde tertiary roads.
gdf_roads = CntryFileQuery.retrieve_cis('main_road') 
frac_unclass = 0

gdf_roads = gdf_roads[gdf_roads.geometry.type=='LineString']
gdf_roads = gdf_roads[(gdf_roads.highway !='tertiary')]
gdf_roads = gdf_roads[(gdf_roads.highway !='tertiary_link')]
...
idx = np.where((df_dependencies.source=='power_line') & (df_dependencies.target=='people'))[0][0]
